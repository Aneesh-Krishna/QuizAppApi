...
namespace QuizAppApi.Migrations
{
    ...
    [Migration("20241127125716_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizAppApi.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuizAppApi.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("QuizAppApi.Models.GroupMember", b =>
                {
            ...
            modelBuilder.Entity("QuizAppApi.Models.Option", b =>
                {
                    b.Property<Guid>("OptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuizAppApi.Models.QuizResponse", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QuizAppApi.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizAppApi.Models.Answer", b =>
                {
                    b.HasOne("QuizAppApi.Models.Option", "Option")
                        .WithMany()
                    ...
                    b.HasOne("QuizAppApi.Models.QuizResponse", "QuizResponse")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("QuizAppApi.Models.GroupMember", b =>
                {
                    b.HasOne("QuizAppApi.Models.Group", "Group")
                        .WithMany("Members")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuizAppApi.Models.ApplicationUser", "User")
